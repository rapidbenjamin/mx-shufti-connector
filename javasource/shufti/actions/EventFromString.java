...
package shufti.actions;

import com.mendix.systemwideinterfaces.core.IContext;
import com.mendix.webui.CustomJavaAction;
import communitycommons.Misc;
import shufti.proxies.Event;
 ...
 */
public class EventFromString extends CustomJavaAction<java.lang.String>
{
	private java.lang.String toConvert;

	public EventFromString(IContext context, java.lang.String toConvert)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		if (toConvert == null || "".equals(toConvert.trim())) {
			return null;
		}
		// enum values cannot contain '.', which are replaced by '_'
		// let's take care of this
		String toConvertWithUnderscores = toConvert.replace('.', '_');
		
		Optional<Event> result = Misc.enumFromString(Event.class, toConvertWithUnderscores);
